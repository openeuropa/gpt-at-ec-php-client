...
final class Factory
{
    ...
    public function make(): Client
    {
        ...
        $baseUri = BaseUri::from($this->baseUri ?: 'api.tech.ec.europa.eu/ecgpt/v1');
    ...
    private function makeStreamHandler(ClientInterface $client): Closure
    {
        ...
        return function (RequestInterface $_): never {
            throw new Exception('To use stream requests you must provide an stream handler closure via the GPT@EC factory.');
        };
    }
